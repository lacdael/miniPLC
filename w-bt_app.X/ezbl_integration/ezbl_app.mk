...
ifneq (,${filter default uart,${CONF}})   # Check if "default" or "uart" MPLAB project build profile is used
	...
	wine "${thisMakefileDir}ezbl_comm.exe" -com=com5 -baud=115200 -timeout=1100 -artifact="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.bl2" 1>&2
	
	#${MP_JAVA_PATH}java -jar "${thisMakefileDir}ezbl_tools.jar" --communicator -com=COM14 -baud=115200 -timeout=1100 -artifact="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.bl2" 1>&2
